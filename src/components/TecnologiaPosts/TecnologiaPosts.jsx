...
export function TecnologiaPosts() {
    ...
    const filteredPosts = posts.filter(post => post.category === 'tecnologia');
                ...
                <div className="post-footer">
                  ...
                  {replyToPost === post.id && (
                    <div className="reply-container">
                      ...
                      />
                      <button onClick={() => handleReply(post.id)}>Responder</button>
                    </div>
                  )}
                </div>
              </div>
  ...
  export default TecnologiaPosts;